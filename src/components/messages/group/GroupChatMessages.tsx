...
export function GroupChatMessages({ groupId, currentUserId, onBack }: GroupChatMessagesProps) {
  const { messages, isLoading, groupInfo, participantCount } = useGroupChat(groupId);
