...
function createResponse(body: any, status: number = 200, additionalHeaders: Record<string, string> = {}) {
  ...
  console.log(`Sending response with status ${status}:`, { headers: responseHeaders });
  return new Response(
    JSON.stringify(body),
    { 
